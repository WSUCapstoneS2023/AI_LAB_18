...
sentences = [    "The quick brown fox jumps over the lazy dog.", "The Porter stemming algorithm (or ‘Porter stemmer’) is a process for removing the commoner James Smith morphological and inflexional endings from words in English. Its main use is as part of a term normalisation process that is usually done when setting up Information Retrieval systems.",    "She sells seashells by the seashore.",    "My favorite color is blue.",    "The cat sat on the mat.",    "The sun rises in the east and sets in the west.",    "The book is on the table.",    "He likes to play soccer and basketball.",    "I have a headache and a fever.",    "The restaurant serves delicious food.",    "She is a talented musician and a great writer."]
